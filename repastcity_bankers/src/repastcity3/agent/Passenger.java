...
public class Passenger implements IAgent {

	private static Logger LOGGER = Logger.getLogger(Passenger.class
			.getName());
	...
	public Passenger() { //bankers change. CONSTRUCTOR.
        this.id = uniqueID++;
