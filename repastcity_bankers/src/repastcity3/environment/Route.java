...
//			}
	...
	public static double[] getRouteDistance	(IAgent agent, Coordinate destination, Building destBuilding) throws Exception {
		...
		for (int i=0; i<r.routeX.size()-1; i++) {
			...
			Coordinate c2 = r.routeX.get(i); // The next one in the route
			...
			myCheck +=1; //what we know: loop works. It iterate through all sections, but it doesn't increment totalDist.
		}
