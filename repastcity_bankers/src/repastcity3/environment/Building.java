...
public class Building implements FixedGeography, Identified {
	...
	private int swimming; //KEJ+ attribute added from shapefile

	private double clubID; //KEJ+ attribute added from shapefile

	private int fitness; //KEJ+ attribute added from shapefile
	
	private int agentsInside=0;
	...
	public void clientEntry() { //should it be synchronized?
		this.clientEntries++;	}
	public int getNumOfClientEntries(){
	...
	public boolean mayIenter(){ //club capacity should come from shapefile. If 1agent is 100 ppl, than an argument may be 100.
