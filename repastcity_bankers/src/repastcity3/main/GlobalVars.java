...
public abstract class GlobalVars {
	...
	//Parameters used by agents
	public static double howLongAtClub = 1.0; // it can be a parameter changed by user, but than I should change checkClubLater 
	public static double checkClubLater = 3.0; // interval at which he checks the club
}
